...
CLEAN_PARQUET = MODELS_DIR / "clean.parquet"
FEATURES_PARQUET = MODELS_DIR / "features.parquet"

# Saved model files
STAGE_A_MODEL = MODELS_DIR / "stage_a_classifier.joblib"
STAGE_B_MODEL = MODELS_DIR / "stage_b_regressor.joblib"
ENCODER_FILE = MODELS_DIR / "encoders.joblib"
CONTRACTOR_SCORES = MODELS_DIR / "contractor_scores.parquet"
