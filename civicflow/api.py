...
@app.get(
    ...
    description="Return service status and whether model artifacts are loaded.",
)
...
@app.get(
    ...
    description="Return 200 only when model artifacts are loaded, otherwise 503.",
)
